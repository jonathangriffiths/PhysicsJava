...
public class PlanetAnalysis {
	...
	/**
	 * 
	 * @param takes the bufferedReader of the planet site
	 * @returns an arraylist of the planet objects
	...
	/**
	 * This looks over the data generated for a single method and returns an arraylist of all planets for this method only
	 * @param The ArrayList generated by the collectData function
	 * @param Method is the string which needs to match the method variable of a planet object
	 * @return Returns the arraylist for one method
	 */
	...
	public static void main(String[] args) {
		...
		/**
		 * testing what happens if I comment in the main part
		 */
		try {
